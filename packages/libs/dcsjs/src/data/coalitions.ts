...
export const coalitions: Record<Coalition, number[]> = {
	...
	neutrals: [
		70, 83, 23, 65, 86, 64, 25, 63, 76, 90, 29, 62, 30, 78, 87, 31, 61, 32, 33, 60, 17, 35, 69, 36, 59, 71, 79, 58, 57,
		56, 55, 88, 73, 39, 89, 54, 77, 72, 41, 42, 44, 85, 75, 53, 22, 52, 66, 51, 74, 82, 7, 68, 50, 49, 48, 67,
	],
